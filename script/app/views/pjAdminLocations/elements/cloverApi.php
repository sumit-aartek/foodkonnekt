...
$address1     = $response_address->address1;
$address2     = $response_address->address2;
$address3     = $response_address->address3;
$city         = $response_address->city;
$country      = $response_address->country;
...
$sql = "SELECT * FROM foodkonnektfood_delivery_locations_map WHERE CLOVER_MID='" . $merchant_id . "' AND USER_ID = ". $user_id;
