...
if (isset($tpl['status']))
{
	...
	<div class="ui-tabs ui-widget ui-widget-content ui-corner-all b10">
		<ul class="ui-tabs-nav ui-helper-reset ui-helper-clearfix ui-widget-header ui-corner-all">
			...
			<li class="ui-state-default ui-corner-top"><a href="<?php echo $_SERVER['PHP_SELF']; ?>?controller=pjAdminMerchant&amp;action=pjActionCreate">Add Merchant</a></li>
			<li class="ui-state-default ui-corner-top ui-tabs-active ui-state-active"><a href="<?php echo $_SERVER['PHP_SELF']; ?>?controller=pjAdminMerchant&amp;action=pjActionUpdate&id=<?php echo $tpl['arr']['merchant_id']; ?>">Update Merchant</a></li>
		</ul>
	</div>
	...
	<form action="<?php echo $_SERVER['PHP_SELF']; ?>?controller=pjAdminMerchant&amp;action=pjActionUpdate" method="post" id="frmCreateUser" class="form pj-form" autocomplete="off">
		<input type="hidden" name="merchant_update" value="1" />
		<input type="hidden" name="id" value="<?php echo (int) $tpl['arr']['merchant_id']; ?>" />
		<p>
			<label class="title">Merchant Name:-</label>
			<span class="inline_block">
				<input type="text" name="merchant_name" id="merchant_name" class="pj-form-field w250 required" value="<?php echo $tpl['arr']['merchant_name']; ?>"/>
			</span>
		</p>
		...
		<p>
			...
			<span class="inline_block">
				<textarea name="merchant_address" id="merchant_address" class="pj-form-field w250 required"><?php echo $tpl['arr']['merchant_address']; ?></textarea>
			</span>
		</p>		
