...
if (isset($tpl['status']))
{
	...
	<div class="ui-tabs ui-widget ui-widget-content ui-corner-all b10">
		<ul class="ui-tabs-nav ui-helper-reset ui-helper-clearfix ui-widget-header ui-corner-all">
			<li class="ui-state-default ui-corner-top ui-tabs-active ui-state-active"><a href="<?php echo $_SERVER['PHP_SELF']; ?>?controller=pjAdminMerchant&amp;action=pjActionIndex">Merchant</a></li>
	...
	var myLabel = myLabel || {};
	myLabel.merchant_name = "<?php __('lblName', false, true); ?>";
	myLabel.merchant_address = "Address";
